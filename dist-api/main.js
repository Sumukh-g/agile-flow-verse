...
async function bootstrap() {
    ...
    app.useGlobalInterceptors(app.get(tenant_context_interceptor_1.TenantContextInterceptor));
    ...
    common_1.Logger.log(`API listening on http://localhost:${port}`);
    common_1.Logger.log(`WebSocket Gateway available at ws://localhost:${port}/realtime`);
}
bootstrap();
