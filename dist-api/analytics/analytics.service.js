...
let AnalyticsService = AnalyticsService_1 = class AnalyticsService {
    ...
    async getProjectAnalytics(tenantId, projectId, query) {
    ...
    async getTaskAnalytics(tenantId, query) {
    ...
    async getUserAnalytics(tenantId, userId, query) {
    ...
    async getTenantAnalytics(tenantId, query) {
    ...
    async calculateProjectAnalytics(tenantId, projectId, query) {
        const where = {
            tenantId,
            projectId,
        };
    ...
    async calculateTaskAnalytics(tenantId, query) {
    ...
    async calculateUserAnalytics(tenantId, userId, query) {
    ...
    async calculateTenantAnalytics(tenantId, query) {
        const where = { tenantId };
        if (query.startDate && query.endDate) {
            where.createdAt = {
                gte: new Date(query.startDate),
    ...
    async getProgressOverTime(tenantId, projectId, query) {
    ...
    async calculateTaskVelocity(tenantId, query) {
