...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        imports: [auth_module_1.AuthModule, prisma_module_1.PrismaModule, kafka_module_1.KafkaModule],
        providers: [realtime_gateway_1.RealtimeGateway, realtime_service_1.RealtimeService],
        exports: [realtime_gateway_1.RealtimeGateway, realtime_service_1.RealtimeService],
    })
], RealtimeModule);
